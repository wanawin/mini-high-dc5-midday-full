...
".join(raw_lines[:50]), height=200), height=200), height=200), height=200), height=200), height=200), height=200)
...
".join(p['name'] for p in parsed[:20]), height=200), height=200), height=200), height=200), height=200), height=200), height=200)
